...
public class Database {
	...
	private static void createDataSource() {
		try {
			...
			ds.setJdbcUrl("jdbc:h2:" + DirtLimits.getPlugin().getDataFolder().getAbsolutePath() + "/data/dirtlimits");
	...
	public static void initialiseDatabase() {
		InputStream inputStream = DirtLimits.getPlugin().getResource("dbsetup.sql");
